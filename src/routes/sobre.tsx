  ...
  head: () => ({
    meta: [
      { title: "Sobre a Conecta | Distribuidor oficial Shinova no Brasil" },
      {
        name: "description",
        content:
          "Distribuidor oficial Shinova no Brasil, com 300 clientes ativos. Sediado em Vespasiano/MG, com entrega nacional, importação direta e suporte técnico próprio.",
      },
      { property: "og:title", content: "Sobre a Conecta, Distribuidor oficial Shinova" },
      {
        property: "og:description",
        content:
          "Distribuidor oficial Shinova no Brasil. 300 clientes ativos, entrega nacional e suporte técnico para clínicas e hospitais veterinários.",
      },
    ],
  }),
  component: SobrePage,
      ...
      <section className="container-edge pb-24">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          <Reveal>
            ...
            <h2 className="mt-4 font-serif text-4xl text-ink leading-tight">
              Equipamento certo, instalado com método, com gente por perto.
            </h2>
          </Reveal>
          <Reveal>
            <div className="space-y-5 text-ink-soft text-lg">
              <p>
                Acreditamos que tecnologia veterinária só vira resultado clínico quando vem
                acompanhada de instalação correta, calibração, treinamento e suporte de verdade.
              </p>
              <p>
                Por isso operamos como uma extensão do time da clínica. Ajudamos a especificar,
                importamos sob demanda equipamentos de alta tecnologia, produzidos sob medida,
                entregamos instalados e calibrados, treinamos a equipe e seguimos disponíveis para
                qualquer dúvida ao longo do uso.
              </p>
              <p>
                O prazo de 60 a 90 dias não é demora, é a garantia de que você recebe um equipamento
                fabricado para a sua operação, com representação oficial e sem intermediário
                inflando preço.
              </p>
            </div>
          </Reveal>
      ...
      <section className="container-edge pb-24">
        ...
        <div className="mt-10 grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          <Pilar
            icon={Globe2}
            t="Importação direta"
            d="Representação oficial, sem intermediário inflando preço. Equipamento de origem com rastreabilidade total."
          />
          <Pilar
            icon={ShieldCheck}
            t="Instalado e calibrado"
            d="Cada equipamento chega instalado, comissionado e calibrado, pronto para operar no primeiro dia."
          />
          <Pilar
            icon={Truck}
            t="Entrega nacional"
            d="Logística coordenada para todo o Brasil, com seguro porta a porta e acompanhamento da chegada."
          />
          <Pilar
            icon={Wrench}
            t="Treinamento e suporte"
            d="Treinamento operacional da equipe incluso e suporte técnico nacional que responde de verdade."
          />
        </div>
      </section>
    ),
    cta: (
      <section className="container-edge pb-24">
        <div className="rounded-3xl bg-conecta-blue text-white p-10 md:p-16 grid md:grid-cols-[1fr_auto] gap-8 items-center">
          <div>
            <span className="font-mono text-[11px] tracking-[0.2em] uppercase text-conecta-orange">
              Conecta · {SITE.city}
            </span>
            <h3 className="mt-4 font-serif text-3xl md:text-4xl leading-tight">
              Vai estruturar ou expandir sua clínica? Vamos montar seu projeto.
            </h3>
          </div>
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <Link
              to="/produtos"
              className="rounded-full border border-white/40 text-white px-6 py-3 text-sm hover:bg-white/10 transition inline-flex items-center justify-center"
            >
              Ver catálogo
            </Link>
          </div>
...
function Metric({ n, l }: { n: string; l: string }) {
  return (
    <div className="bg-paper p-10">
      ...
      <div className="mt-2 font-mono text-[11px] tracking-[0.18em] uppercase text-ink-soft">
        {l}
      </div>
    </div>
  );
