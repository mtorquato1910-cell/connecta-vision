    ...
    <header className="sticky top-0 z-40 bg-background/85 backdrop-blur-md border-b border-border">
      <div className="max-w-7xl mx-auto container-x py-3 md:py-4 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          <a href={`tel:+55${PHONE_DISPLAY.replace(/\D/g, "")}`} className="hidden lg:flex items-center gap-1.5 text-sm font-medium text-primary hover:text-accent transition min-h-[44px]">
          ...
          <a
            ...
            className="hidden sm:inline-flex items-center gap-1.5 px-4 min-h-[44px] py-2.5 rounded-lg border border-primary/30 text-primary text-sm font-semibold hover:border-accent hover:text-accent transition"
          >
            <ExternalLink className="w-4 h-4" /> Conheça nosso site
          </a>
          <a
            href="#orcamento"
            className="inline-flex items-center gap-2 px-4 min-h-[44px] py-2.5 rounded-lg bg-accent text-accent-foreground text-sm font-semibold hover:brightness-110 transition shadow-md hover:-translate-y-0.5 hover:shadow-lg"
          >
    ...
    <section className="relative">
      <div className="max-w-7xl mx-auto container-x py-12 sm:py-16 md:py-24 grid lg:grid-cols-[1.1fr_1fr] gap-10 lg:gap-16 items-start">
        ...
        >
          ...
          <h1
            className="font-display fluid-hero text-primary mt-6 tracking-tight"
          ...
          <p className="mt-6 sm:mt-8 text-base sm:text-lg text-foreground/75 max-w-xl leading-relaxed">{h.subtitle}</p>
          ...
          <div className="mt-8 sm:mt-10 flex flex-wrap items-center gap-4 sm:gap-5">
            <a href="#galeria" className="inline-flex items-center justify-center gap-2 px-6 min-h-[48px] py-3.5 rounded-lg bg-primary text-primary-foreground font-semibold hover:bg-primary/90 transition shadow-lg">
              {h.ctaPrimary} <ArrowRight className="w-4 h-4" />
            </a>
            <a href="#orcamento" className="inline-flex items-center min-h-[44px] text-sm font-semibold text-primary hover:text-accent transition story-link">
    ...
    <section className="py-20 sm:py-24 md:py-32 bg-background">
      <div className="max-w-7xl mx-auto container-x">
        <div className="max-w-3xl mb-12 sm:mb-14">
          ...
          <h2
            className="font-display fluid-h2-sm text-primary"
...
function Testimonial() {
  ...
  return (
    <section className="relative py-20 sm:py-28 md:py-36 bg-[var(--brand-navy-deep)] overflow-hidden">
      <span className="absolute top-4 left-3 sm:top-8 sm:left-6 md:top-12 md:left-16 font-display text-[8rem] sm:text-[12rem] md:text-[18rem] leading-none text-accent/15 select-none pointer-events-none">"</span>
      <div className="relative max-w-4xl mx-auto container-x text-center">
        <blockquote className="font-display italic text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white leading-[1.25]">
          {t.quote}
        </blockquote>
        <div className="mt-10 flex items-center justify-center gap-4">
          <img src={t.avatar} alt="" loading="lazy" className="w-14 h-14 rounded-full object-cover border-2 border-accent/50" />
      ...
      <div className="max-w-7xl mx-auto container-x grid sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 mb-12 sm:mb-14">
        ...
        <div>
          <span className="inline-flex bg-white rounded-2xl px-4 py-3 mb-5 shadow-sm">
            <img src={logo} alt="Conecta" loading="lazy" className="h-12 md:h-14 w-auto" />
          </span>
...
function FloatingWhatsApp() {
  return (
    <a
      ...
      className="wa-float fixed safe-bottom safe-right z-50 inline-flex items-center justify-center w-14 h-14 rounded-full bg-[var(--whatsapp)] text-white shadow-2xl shadow-[var(--whatsapp)]/40 hover:scale-105 transition"
    >
